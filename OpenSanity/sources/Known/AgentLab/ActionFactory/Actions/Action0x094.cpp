#include "headers/Known/AgentLab/ActionFactory/Actions/Action0x094.h"

#include "headers/Known/Game/InstanceSystem/InstanceContext.h"
void Action0x094::Dispose(byte param_1) {
	Logging::LogUnimplemented(__FUNCSIG__);
	/*
	ActionAbstract * __thiscall Action0x094::Dispose(Action0x094 *this,byte param_1){
		thunk_FUN_000555d0(&this->parent);
		if ((param_1 & 1) != 0) {
...
void Action0x094::ExecuteFromCallContext(uint time_clock, InstanceContext* ctx) {
	Logging::LogUnimplemented(__FUNCSIG__);
	/*
	void __thiscall Action0x094::ExecuteFromCallContext(Action0x094 *this,undefined4 time_clock,InstanceContext *ctx){
		...
		pIVar2[10].time = (uint)fVar6;
		}
		if ((*(byte *)&this->unlabelled24 & 2) != 0) {
		pIVar7 = (InstanceNodeAbstract *)FUN_00180490(&this->unlabelled16,pvVar5);
		pIVar2[10].field5_0x10 = pIVar7;
		}
		if ((*(byte *)&this->unlabelled24 & 4) != 0) {
		fVar6 = FUN_00180490(&this->unlabelled20,pvVar5);
		pIVar2[10].field6_0x14 = (uint)fVar6;
		}
		}
		return;
		}
...
void Action0x094::Construct() {
	Logging::LogUnimplemented(__FUNCSIG__);
	/*
	Action0x094 * __fastcall Action0x094::Construct(Action0x094 *this){
		(this->parent).nextAction = (ActionAbstract *)0x0;
		(this->parent).field1_0x4 = 0xffffff;
		(this->parent).vtable = (ActionAbstract_VTable *)&Action_VT_ID_0x094;
		this->unlabelled12 = 0;
		this->unlabelled16 = 0;
		this->unlabelled20 = 0;
...
int Action0x094::GetSize() {
	Logging::LogUnimplemented(__FUNCSIG__);
	/*
	 WARNING: Unknown calling convention yet parameter storage is locked int Action0x094::GetSize(void){
		return 0x1c;
		}
...
void Action0x094::UnkMethod(int* param_1) {
	Logging::LogUnimplemented(__FUNCSIG__);
	/*
	void __thiscall Action0x094::UnkMethod(Action0x094 *this,int *param_1){
		short sVar1;
		char cVar2;
		short *this_00;
		uint uVar3;
		...
		LAB_0019787f:this->unlabelled24 = uVar3;
		}
		else {
		if (sVar1 == 0xdd) {
