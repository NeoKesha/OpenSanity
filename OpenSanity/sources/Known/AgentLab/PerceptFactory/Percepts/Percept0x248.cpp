#include "headers/Known/AgentLab/PerceptFactory/Percepts/Percept0x248.h"

#include "headers/Known/Game/InstanceSystem/InstanceContext.h"
float Percept0x248::GetUtilityScore(InstanceContext* param_1) {
	Logging::LogUnimplemented(__FUNCSIG__);
	/*
	 WARNING: Type propagation algorithm not settling  WARNING: Globals starting with '_' overlap smaller symbols at the same address float __thiscall Percept0x248::GetUtilityScore(Percept0x248 *this,InstanceContext *param_1){
		...
		local_280 = local_280 - local_250;
		local_27c = local_27c - local_24c;
		local_278 = local_278 - local_248;
		local_284 = local_264;
		local_290 = local_270 - local_280;
		local_28c = local_26c - local_27c;
		local_234.field4_0xc = local_234.field4_0xc & 0xfffffffe;
		local_288 = local_268 - local_278;
		local_234.field1_0x4 = 0;
		local_234.field9_0x20 = (InstanceContext *)0x0;
		local_234.field3_0x8 = FLOAT_0038ad18;
		cVar3 = FUN_001eb7a0((int)(((param_1->parent).ctx)->parent).chunkData,&local_280,&local_290,0x80,&local_234,DAT_00495d28);
...
void Percept0x248::Construct() {
	Logging::LogUnimplemented(__FUNCSIG__);
	/*
	Percept0x248 * __fastcall Percept0x248::Construct(Percept0x248 *this){
		(this->parent).PerceptID = 0;
		*(undefined2 *)&(this->parent).PerceptID = 0x248;
		(this->parent).vtable = &Percept_VT_ID_0x248;
		return this;
		}
...
void Percept0x248::Dispose(byte param_1) {
	Logging::LogUnimplemented(__FUNCSIG__);
	/*
	Percept0x248 * __thiscall Percept0x248::Dispose(Percept0x248 *this,byte param_1){
