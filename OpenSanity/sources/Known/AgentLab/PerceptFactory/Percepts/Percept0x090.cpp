#include "headers/Known/AgentLab/PerceptFactory/Percepts/Percept0x090.h"

#include "headers/Known/Game/InstanceSystem/InstanceContext.h"
float Percept0x090::GetUtilityScore(InstanceContext* param_1) {
	Logging::LogUnimplemented(__FUNCSIG__);
	/*
	float __thiscall Percept0x090::GetUtilityScore(Percept0x090 *this,InstanceContext *param_1){
		...
		fVar5 = (transform->matrix).m11;
		fVar6 = (transform->matrix).m12;
		fVar7 = (transform->matrix).m13;
...
void Percept0x090::Dispose(byte param_1) {
	Logging::LogUnimplemented(__FUNCSIG__);
	/*
	Percept0x090 * __thiscall Percept0x090::Dispose(Percept0x090 *this,byte param_1){
...
void Percept0x090::Construct() {
	Logging::LogUnimplemented(__FUNCSIG__);
	/*
	void __fastcall Percept0x090::Construct(Percept0x090 *this){
		(this->parent).PerceptID = 0;
		*(undefined2 *)&(this->parent).PerceptID = 0x90;
		(this->parent).vtable = &Percept_VT_ID_0x90;
		return;
		}
