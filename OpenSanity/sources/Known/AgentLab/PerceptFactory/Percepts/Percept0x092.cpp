#include "headers/Known/AgentLab/PerceptFactory/Percepts/Percept0x092.h"

#include "headers/Known/Game/InstanceSystem/InstanceContext.h"
float Percept0x092::GetUtilityScore(InstanceContext* param_1) {
	Logging::LogUnimplemented(__FUNCSIG__);
	/*
	float __thiscall Percept0x092::GetUtilityScore(Percept0x092 *this,InstanceContext *param_1){
		...
		fVar5 = (transform->matrix).m31;
		fVar6 = (transform->matrix).m32;
		fVar7 = (transform->matrix).m33;
...
void Percept0x092::Dispose(byte param_1) {
	Logging::LogUnimplemented(__FUNCSIG__);
	/*
	Percept0x092 * __thiscall Percept0x092::Dispose(Percept0x092 *this,byte param_1){
...
void Percept0x092::Construct() {
	Logging::LogUnimplemented(__FUNCSIG__);
	/*
	void __fastcall Percept0x092::Construct(Percept0x092 *this){
		(this->parent).PerceptID = 0;
		*(undefined2 *)&(this->parent).PerceptID = 0x92;
		(this->parent).vtable = &Percept_VT_ID_0x92;
		return;
		}
