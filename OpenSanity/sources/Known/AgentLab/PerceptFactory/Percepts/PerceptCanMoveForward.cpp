#include "headers/Known/AgentLab/PerceptFactory/Percepts/PerceptCanMoveForward.h"

#include "headers/Known/Game/InstanceSystem/InstanceContext.h"
float PerceptCanMoveForward::GetUtilityScore(InstanceContext* param_1) {
	Logging::LogUnimplemented(__FUNCSIG__);
	/*
	float __thiscall PerceptCanMoveForward::GetUtilityScore(PerceptCanMoveForward *this,InstanceContext *param_1){
		float fVar1;
		float fVar2;
		float fVar3;
		...
		local_28 = (this->parent).Threshold;
		pIVar5 = (pIVar4->parent).transform;
		local_40 = local_50;
		local_3c = local_4c;
		local_38 = local_48;
...
void PerceptCanMoveForward::Construct() {
	Logging::LogUnimplemented(__FUNCSIG__);
	/*
	PerceptCanMoveForward * __fastcall PerceptCanMoveForward::Construct(PerceptCanMoveForward *this){
		(this->parent).PerceptID = 0;
		*(undefined2 *)&(this->parent).PerceptID = 0x20d;
		(this->parent).vtable = &Percept_VT_CanMoveForward;
		return this;
		}
...
void PerceptCanMoveForward::Dispose(byte param_1) {
	Logging::LogUnimplemented(__FUNCSIG__);
	/*
	PerceptCanMoveForward * __thiscall PerceptCanMoveForward::Dispose(PerceptCanMoveForward *this,byte param_1){
