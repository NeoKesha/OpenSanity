...
void UnkFamily5A::Construct(ushort param_1, InstanceContextRefCounter* param_2, uint param_3) {
	Logging::LogUnimplemented(__FUNCSIG__);
	/*
	UnkFamily5A * __thiscall UnkFamily5A::Construct(UnkFamily5A *this,short param_1,InstanceContextRefCounter *param_2,int param_3){
		uint uVar1;
		InstanceContextRefCounter *local_4;
		local_4 = param_2;
		if (param_2 != (InstanceContextRefCounter *)0x0) {
		...
		(this->parent).field5_0x10 = param_2;
		if (param_2 != (InstanceContextRefCounter *)0x0) {
		uVar1 = param_2->refCount;
		param_2->refCount = (uVar1 + 1 ^ uVar1) & 0xffffff ^ uVar1;
		}
		InstanceContextSmartPtr::Release(&local_4);
		(this->parent).vtable = &UnkFamily5_VT_A;
		InstanceContextSmartPtr::Release(&param_2);
		return this;
		}
...
void UnkFamily5A::Dispose(byte param_1) {
	Logging::LogUnimplemented(__FUNCSIG__);
	/*
	UnkFamily5Base * __thiscall UnkFamily5A::Dispose(UnkFamily5A *this,byte param_1){
...
void UnkFamily5A::EmptyFunction() {
	Logging::LogUnimplemented(__FUNCSIG__);
	/*
	void UnkFamily5A::EmptyFunction(void){
		return;
		}
