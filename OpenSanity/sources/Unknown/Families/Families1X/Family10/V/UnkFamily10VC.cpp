...
void UnkFamily10VC::Construct(int param_1, uint param_2) {
	Logging::LogUnimplemented(__FUNCSIG__);
	/*
	UnkFamily10VC * __thiscall UnkFamily10VC::Construct(UnkFamily10VC *this,int param_1,int param_2){
		...
		(this->parent).parent.vtable = (UnkFamily10Base_VTable *)&UnkFamily10_VT_VC;
		...
		UnkFamily8B::Construct((UnkFamily8B *)element,uVar2 + 0x77,uVar2,(UnkFamily10Base *)0x0,1);
		(element->parent).parent.vtable = &UnkFamily8_VT_BC;
		TwinString::Set(&element->name,"Extras\\Concept\\Concept");
...
void UnkFamily10VC::FUN_000a6ee0() {
	Logging::LogUnimplemented(__FUNCSIG__);
	/*
	void __fastcall UnkFamily10VC::FUN_000a6ee0(UnkFamily10VC *this){
		byte bVar1;
		int iVar2;
		uint uVar3;
		uint *puVar4;
...
void UnkFamily10VC::Dispose(byte param_1) {
	Logging::LogUnimplemented(__FUNCSIG__);
	/*
	undefined4 * __thiscall UnkFamily10VC::Dispose(UnkFamily10VC *this,byte param_1){
