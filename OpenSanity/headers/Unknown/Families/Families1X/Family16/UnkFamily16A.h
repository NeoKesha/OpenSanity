...
class UnkFamily16A : public UnkFamily16Base {
	public:
		...
		virtual AutoClass16* FUN_001b1e00(short param_1);
		...
		AutoClass16* CreateNewRecord(char* str, ChunkData* param_2, uint param_3, UnkFamily15A* param_4);
		virtual AutoClass16* AddNewRecord(char* str, ChunkData* param_2);
