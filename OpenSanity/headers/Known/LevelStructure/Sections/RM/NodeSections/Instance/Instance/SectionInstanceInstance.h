...
class SectionInstanceInstance : public SectionAbstract {
	public:
		...
		virtual SectionReaderInstanceInstance* GetReader(uint param_1, uint param_2, int* param_3);
		...
		void Construct(uint resources, CollectionInstanceWrapper* instances);
